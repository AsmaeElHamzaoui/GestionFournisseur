...
<form:form modelAttribute="fournisseur" method="post" action="${pageContext.request.contextPath}/fournisseurs/add">
    <table>
        ...
        <tr><td colspan="2"><button type="submit">Enregistrer</button></td></tr>
    </table>
</form:form>
